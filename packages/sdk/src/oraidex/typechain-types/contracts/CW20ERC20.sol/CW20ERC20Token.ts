...
export interface CW20ERC20TokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AddrPrecompile"
      | "BankPrecompile"
...
export interface CW20ERC20Token extends BaseContract {
  connect(runner?: ContractRunner | null): CW20ERC20Token;
  waitForDeployment(): Promise<this>;

  interface: CW20ERC20TokenInterface;
  ...
  cw20Address: TypedContractMethod<[], [string], "view">;
