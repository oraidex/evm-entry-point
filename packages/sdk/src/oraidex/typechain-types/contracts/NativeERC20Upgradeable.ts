...
export interface NativeERC20UpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AuthzPrecompile"
      | "BankPrecompile"
...
export interface NativeERC20Upgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): NativeERC20Upgradeable;
  waitForDeployment(): Promise<this>;

  interface: NativeERC20UpgradeableInterface;
