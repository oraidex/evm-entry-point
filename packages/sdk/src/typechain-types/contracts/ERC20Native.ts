...
export interface ERC20NativeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AddrPrecompile"
      | "AuthzPrecompile"
...
export interface ERC20Native extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20Native;
  waitForDeployment(): Promise<this>;

  interface: ERC20NativeInterface;
