...
export interface ERC20NativeUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AddrPrecompile"
      | "AuthzPrecompile"
...
export interface ERC20NativeUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20NativeUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: ERC20NativeUpgradeableInterface;
