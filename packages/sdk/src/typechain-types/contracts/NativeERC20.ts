...
export interface NativeERC20Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "AuthzPrecompile"
      | "BankPrecompile"
...
export interface NativeERC20 extends BaseContract {
  connect(runner?: ContractRunner | null): NativeERC20;
  waitForDeployment(): Promise<this>;

  interface: NativeERC20Interface;
